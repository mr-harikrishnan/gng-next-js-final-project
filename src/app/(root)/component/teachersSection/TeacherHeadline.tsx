  ...
  return (
    <div className='bottom-animated-img w-full px-3.5 md:px-18.5 lg:px-20 xl:px-5'>
      <div className='w-full  md:mt-5 '>
        ...
        <h1 className='font-morebold text-[32px] text-center mt-8 leading-9 md:text-[36px] lg:text-[42px] lg:mt-9'>Your Learning. Our Guidance.</h1>
        <p className='font-primary text-[#535756] text-[20px] text-center mt-6 lg:mt-7'>Vaathiyar.ai isn’t just an app — it’s your personal mentor. With every minute you study, we track, quiz, and support your growth — all without human intervention.</p>
