  ...
  return (
    ...
    <div className="grid grid-cols-2 place-items-center lg:pr-4 lg:mb-20 xl:mb-33 max-w-100 sm:max-w-161 md:max-w-189">
      ...
      <div className=" ml-12 relative ">
        ...
        <img src={anPe1.src} alt="" className="zoom-scale mr-12 mb-20 w-33 sm:w-61 sm:ml-7 sm:-mt-5 md:-mt-5 md:ml-24 md:min-w-67 lg:-mt-8 lg:-ml-3.5 lg:min-w-50 xl:min-w-65 xl:-mt-8 xl:mr-14.5" />
        <img src={blueCircle.src} alt="" className="zoom-scale-loop absolute left-[-80px] top-[77px] w-[76px] sm:left-[-42px] sm:top-[110px] md:left-[0.5px] md:top-[125px] lg:left-[-100px] lg:top-[110px] xl:left-[-127px] xl:top-[122px]" />

      </div>
      <div className="xl:mr-1 mt-9 relative">
        <img src={anhola.src} alt="" className="right-animated-img absolute left-19 top-1.5  w-16 z-10 sm:top-7 sm:left-35 sm:w-22.5 md:top-[37px] md:left-[145px] lg:top-29.5 lg:left-37" />
        <img src={anPe2.src} alt="" className="zoom-scale mt-11 mr-12  w-33 sm:w-61 sm:-ml-7 sm:mt-16 md:w-67 md:mr-21 lg:w-58 lg:mt-39 lg:-ml-3.5 xl:w-65 xl:-ml-9.5" />
        <img src={purpleCicle.src} alt="" className="zoom-scale-loop absolute top-[-11px] left-[5px] w-[48px] sm:top-[2px] sm:left-[24px] md:left-[-13px] lg:left-[55px]  lg:top-[67px] xl:left-[40px] xl:top-[70px]" />

      </div>

      <div className=" -mt-10.5 lg:-mt-14 ml-12 relative">
        <img src={anhoj.src} alt="" className="left-animated-img absolute top-8 right-27.5 w-16 z-10 sm:-top-2 sm:-left-11 sm:w-22.5 md:left-[-20px] md:top-[-2.5px]  lg:-top-36.5 lg:-left-8 xl:-top-14.5 xl:-left-35.5" />
        <img src={anPe3.src} alt="" className="zoom-scale mb-19.5  w-33 sm:w-61 sm:ml-7 sm:-mt-10 md:w-67 md:-mt-8 md:ml-12 lg:-ml-8 lg:-mt-26.5 lg:min-w-58 xl:min-w-65 xl:-mt-26 xl:-ml-16 " />
        <img src={orangeCicle.src} alt="" className="zoom-scale-loop absolute left-[25px] bottom-[10px] w-[52px] sm:left-[77px] sm:bottom-[-5px] md:bottom-[-28px] md:left-[105px] lg:top-[200px] lg:left-[13px] xl:left-[-12px] xl:top-[230px]" />
      </div>
