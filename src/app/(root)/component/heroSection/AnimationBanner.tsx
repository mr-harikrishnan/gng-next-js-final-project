   ...
   <div className="w-full  mx-auto  lg:w-[50%] relative ">
            ...
            <div className="grid grid-cols-2 place-items-center ">
              ...
              <div className="mt-1.5 lg:ml-1.5  relative">
                ...
                <img src={greenCircle.src} alt="" className="absolute right-[25px] top-[-5px] w-[40px] sm:right-[-19px] sm:top-[14px] md:right-[0px] md:top-[23px]  lg:left-[20px] lg:top-[9px] xl:left-[19px] xl:top-[4px]" />
