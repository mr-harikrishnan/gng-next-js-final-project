    ...
    <div className='bottom-animated-img px-3.5 sm:px-19 md:px-[89px] w-full md:mt-5 md:mb-5.5 lg:px-0 lg:mt-10 lg:mr-4 xl:mr-0  '>
      ...
      <div className=' w-full pt-[10px] sm:pt-[11px]  lg:mt-7.5'>
        ...
        <div className='md:px-14 lg:px-0 '>
          <div className='mt-12.5 text-[20px] text-[#4b4b4b] text-center sm:px-1 md:px-4 md:mt-12 lg:text-left lg:px-0 lg:pr-12 lg:mt-7 xl:mt-8 xl:ml-2'>
          ...
          <form action="" className='flex items-center justify-center w-full border mt-12.5 py-4 border-[#535756] hover:border-[#6754A4]  rounded-xl text-lg
                     sm:justify-between sm:px-5  md:mt-15 md:mx-1 md:rounded-lg lg:mt-12.5 lg:mx-0 '>
            <input type="text" name="" id="" placeholder='Search course,mentor...' className='appearance-none placeholder-[#646B6A] sm:w-full focus:border-none focus:outline-none text-[20px] text-gray-600' />
            <button className=' bg-[#6754A4] hover:bg-secondary hover:border-primary   hover:border ml-1 px-4.5 py-3 rounded-lg cursor-pointer'>
