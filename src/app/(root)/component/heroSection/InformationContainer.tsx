    ...
    return (
        <div className='px-3.5   w-full'>
            ...
            <div className='w-full pt-[10px] '>
                <div>
                    <h1 className='text-[40px] font-morebold text-center leading-12 '>Learn With The Best Online School.</h1>
                </div>

                <div className='mt-12.5 text-[20px] text-[#535756] text-center'>
                ...
                <form action="" className='flex items-center  justify-center w-full  border  mt-12.5 py-4 border-[#535756]  rounded-xl text-lg'>
                    <input type="text" name="" id="" placeholder='Search course, mentor ect' className='placeholder-[#646B6A]' />
