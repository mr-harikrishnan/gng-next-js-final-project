    ...
    <div className="overflow-auto ">
      ...
      <section
        ...
        <div className="w-full h-full flex flex-col  lg:flex-row gap-11 ">
          ...
          <div className="w-full  mx-auto  lg:w-[50%] relative ">
            ...
            <div className="grid grid-cols-2 place-items-center mb-20">
              ...
              <div className=" ml-12 relative ">
                ...
                <img src={blueCircle.src} alt="" className="absolute left-[-80px] top-[77px] w-[76px] sm:left-[-42px] sm:top-[110px] md:-left-[440px] xl:bottom-[184px] xl:-left-[400px]" />
              ...
              <div className="xl:mr-1 mt-9 relative">
                ...
                <img src={purpleCicle.src} alt="" className="absolute top-[-11px] left-[5px] w-[48px] sm:top-[2px] sm:left-[24px] lg:left-[268px] lg:top-[36px] xl:left-[310px]" />

              </div>

              <div className=" -mt-10.5 lg:-mt-14 ml-12 relative">
                <img src={anhoj.src} alt="" className="absolute top-8 right-27.5 w-16 z-10 | sm:-top-2 sm:-left-11 sm:w-22.5 | md:left-[-20px] md:top-[-2.5px]  | lg:-top-36.5 lg:-left-8 xl:-top-16 xl:-left-27" />
                <img src={anPe3.src} alt="" className="mb-19.5  w-33 sm:w-61 sm:ml-7 sm:-mt-10 | md:w-67 md:-mt-8 md:ml-12 | lg:-ml-8 lg:-mt-26.5 lg:min-w-58 xl:min-w-65 xl:-mt-27 xl:mr-10 " />
                <img src={orangeCicle.src} alt="" className="absolute left-[25px] bottom-[10px] w-[52px] sm:left-[77px] sm:bottom-[-5px] lg:-left-[180px] lg:bottom-[24px] xl:-left-[236px]" />
              </div>
              ...
              <div className="mt-1.5 relative">
                ...
                <img src={greenCircle.src} alt="" className="absolute right-[25px] top-[-5px] w-[40px] sm:right-[-19px] sm:top-[14px]  lg:left-[220px] lg:-top-[4px] xl:left-[268px] xl:-top-[8px]" />
          ...
          <div className=" border h-500   bg-gray lg:w-[50%] ">
